...
<div style="text-align:left;">
    <a href="{{ action('App\Http\Controllers\Admin\CategoriasController@index') }}" class="btn btn-success"><span style="color:white"><i class="fas fa-chevron-circle-left"></i> Volver a Categorías</span></a>
</div>
